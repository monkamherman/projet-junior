...
exports.generateAttestationPDF = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const generateAttestationPDF = async (attestation, inscription) => {
    const pdfPath = path_1.default.join(__dirname, "../../public/attestations", `${attestation.numero}.pdf`);
    // Créer le répertoire s'il n'existe pas
    const attestationsDir = path_1.default.dirname(pdfPath);
    if (!fs_1.default.existsSync(attestationsDir)) {
        fs_1.default.mkdirSync(attestationsDir, { recursive: true });
    }
  ...
  `;
    ...
    fs_1.default.writeFileSync(pdfPath.replace(".pdf", ".html"), htmlContent);
...
Fait le ${new Date().toLocaleDateString("fr-FR")}
  `;
    fs_1.default.writeFileSync(pdfPath, textContent);
    return pdfPath;
};
exports.generateAttestationPDF = generateAttestationPDF;
